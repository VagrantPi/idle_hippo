...
class IdleIncomeService {
  ...
  double get currentIdlePerSec {
    ...
    // 基礎放置速率
    final baseVal = _configService.getValue(
      'game.idle.base_per_sec',
      defaultValue: 0.1,
    );
    ...
    if (_petService.currentState.pets.isEmpty &&
        _currentGameState?.petState != null) {
  ...
  Map<String, dynamic> getStats() {
    return {
      ...
      'averageIncomePerSec': _totalIdleTime > 0
          ? _totalIdleIncome / _totalIdleTime
          : 0.0,
