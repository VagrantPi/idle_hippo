...
class NoteComponent extends PositionComponent
  ...
  void updatePosition(double currentTimeSec) {
    ...
    final timeUntilHit = note.time - currentTimeSec;
    // 通過判定線後仍保持顯示，直到離開畫面底部

    // Calculate position along the lane
    final progress = 1.0 - (timeUntilHit * 1000 / approachTimeMs);
