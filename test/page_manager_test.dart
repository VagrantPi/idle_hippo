...
void main() {
  group('PageManager 測試', () {
    ...
    test('應回傳正確的頁面圖示路徑', () {
      expect(
        pageManager.getPageIconPath(PageType.home),
        equals('assets/images/icon/Home.png'),
      );
      expect(
        pageManager.getPageIconPath(PageType.equipment),
        equals('assets/images/icon/Equipment.png'),
      );
      expect(
        pageManager.getPageIconPath(PageType.pets),
        equals('assets/images/icon/Pet.png'),
      );
      expect(
        pageManager.getPageIconPath(PageType.shop),
        equals('assets/images/icon/Shop.png'),
      );
      expect(
        pageManager.getPageIconPath(PageType.titles),
        equals('assets/images/icon/TitleBadge.png'),
      );
      expect(
        pageManager.getPageIconPath(PageType.quest),
        equals('assets/images/icon/Quest.png'),
      );
      expect(
        pageManager.getPageIconPath(PageType.settings),
        equals('assets/images/icon/Setting.png'),
      );
      expect(
        pageManager.getPageIconPath(PageType.musicGame),
        equals('assets/images/icon/MusicGame.png'),
      );
      expect(
        pageManager.getPageIconPath(PageType.noAds),
        equals('assets/images/icon/NOADS.png'),
      );
    });
